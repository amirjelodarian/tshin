        ...
        <div class="col-lg-9 col-md-9">
            <div id="tools">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 hidden-xs text-right"> <a href="foods_grid.php" class="bt_filters"><i class="icon-th"></i></a>  <a href="#" class="bt_filters"><i class=" icon-list"></i></a>
                    </div>
                </div>
            </div>
            <?php $foods->AllFoods(); ?>
