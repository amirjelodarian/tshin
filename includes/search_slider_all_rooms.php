            ...
            <div class="col-lg-9 col-md-9">
                <div id="tools">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-12 text-center"> <a href="RoomsGrid.php" class="bt_filters"><i class="icon-th"></i></a>  <a href="RoomsList.php" class="bt_filters"><i class=" icon-list"></i></a></div>
        </form>
        <form method="post" action="<?php echo (htmlspecialchars($_SERVER['PHP_SELF'])); ?>">
