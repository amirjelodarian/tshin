...
<h2>
    ...
    if ($SelectReservedMode[1] == "booked"){
        echo("
                <div id='rooms' class='published'>({$rooms->CountUserBookedAndNotBookedRoomReservationPanel(1)})&nbsp;رزرو شده</div><hr/>
        ...
        echo("
                    <div id='rooms' class='unpublished'>({$rooms->CountUserBookedAndNotBookedRoomReservationPanel(0)})&nbsp;در حال رزرو</div><hr/>
    ...
    <form method="get" action="<?php echo($_SERVER['PHP_SELF']); ?>">
        <div class="publish">
            <select name="select_booking">
                <option value="notbooked" id="unpublished" <?php if($SelectReservedMode[1] == "notbooked") echo "selected"; ?>><?php echo("({$rooms->CountUserBookedAndNotBookedRoomReservationPanel(0)})"); ?>&nbsp;در حال رزرو</option>
                <option value="booked" id="published" <?php if($SelectReservedMode[1] == "booked") echo "selected"; ?>><?php echo("({$rooms->CountUserBookedAndNotBookedRoomReservationPanel(1)})"); ?>&nbsp;رزرو شده</option>
