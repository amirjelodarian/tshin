        ...
        <div class="col-lg-9 col-md-8">
            <div id="tools">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 hidden-xs text-right"> <a href="#" class="bt_filters"><i class="icon-th"></i></a>  <a href="all_hotels_list.php" class="bt_filters"><i class=" icon-list"></i></a>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="hotel_container">
                        <div class="img_container">
                            <a href="single_hotel.php">
                                ...
                                <div class="short_info hotel">تور دریایی<span class="price"><sup>۴۲.۰۰۰ تومان</sup></span>
                                </div>
                            </a>
                        </div>
                        <div class="hotel_title">
                            <h3><strong>اتاق چهار،</strong>دو تخت یک نفره، ظرفیت ۴ نفر</h3>
