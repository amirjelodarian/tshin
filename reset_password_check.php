...
if (isset($_POST["submit"])){
    $users->CheckResetPassword();
}
if(isset($_SESSION["reset_tel"]) && isset($_SESSION["random_code"])){
    if (isset($_POST["reset_pass_submit"]))
        $users->ResetPasswordCheckCode();
} else{ $users->redirect_to("reset_password.php"); }
echo ($_SESSION["random_code"]);
echo "<br />";
echo $_SESSION["reset_tel"];
            ...
            <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
                <div id="login">
                    ...
                    <form method="post" action="<?php echo($_SERVER['PHP_SELF']); ?>">
                        ...
                        <input class="btn_full" name="reset_pass_submit" type="submit" value="Submit" />
                    </form>
                </div>
            </div>
        </div>
